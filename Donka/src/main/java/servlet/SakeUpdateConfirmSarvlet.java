...
/**
 * Servlet implementation class SakeUpdateConfirmSarvlet
 */
@WebServlet("/SakeUpdateConfirm")
public class SakeUpdateConfirmSarvlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SakeUpdateConfirmSarvlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//リクエストパラメータを受け取る
		String sakeId = request.getParameter("sakeId2");
		...
		//daoの実行
		try {
			processingNumber = dao.update(sake);
