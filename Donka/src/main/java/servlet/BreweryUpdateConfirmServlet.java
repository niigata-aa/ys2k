...
/**
 * Servlet implementation class BreweryUpdateConfirmServlet
 */
@WebServlet("/BreweryUpdateConfirm")
public class BreweryUpdateConfirmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BreweryUpdateConfirmServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			processingNumber = dao.update(brewery);	
