...
<body>
	...
	酒蔵id：<input type="text" id="breweryId" name="breweryId" placeholder="4桁の数字" required><br>
	酒蔵の名前：<input type="text" id="breweryName" name="breweryName" required><br>
	酒蔵の写真：<input type="text" id="bImgPath" name="bImgPath" placeholder="写真のURL"><br>
	酒蔵の説明：<input type="text" id="explanation" name="explanation" required><br>
	...
	酒蔵の地域：<select name="areaId" id="areaId">
					<option hidden value="">--酒蔵の地域を選択--</option>
					<option value=1>上越</option>
					<option value=2>中越</option>
					<option value=3>下越</option>
					<option value=4>佐渡</option>
				</select><br>
	予約の可否：<input type="checkbox" id="reserveFlag" name="reserveFlag" required/><br>
